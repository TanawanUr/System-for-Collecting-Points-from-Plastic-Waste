  ...
  Future<Map<String, dynamic>> login(String username, String password) async {
    ...
    if (response.statusCode == 200) {
      final Map<String, dynamic> responseData =
          jsonDecode(utf8.decode(response.bodyBytes)); // Decode with UTF-8
      return responseData;
    } else {
...
class ApiService {
  ...
  Future saveUser(String e_passport, String firstname, String lastname,
      String email, String token, String facname, String depname) async {
  ...
  Future<List<Map<String, dynamic>>> getRewards() async {
    try {
      final response =
          await http.get(Uri.parse("$baseUrl/api/rewards/stationery"));
  ...
  Future<List<Map<String, dynamic>>> getCertificate() async {
    try {
      final response =
          await http.get(Uri.parse("$baseUrl/api/rewards/certificates"));
  ...
  Future<List<Map<String, dynamic>>> getAffectiveScore() async {
    try {
      final response =
          await http.get(Uri.parse("$baseUrl/api/rewards/affectivescore"));
...
/*PROFESSOR*/
  ...
  Future<List<Map<String, dynamic>>> getProffessorAffectiveReqList() async {
    ...
    final response =
        await http.get(Uri.parse('$baseUrl/professor/request-list'));
  ...
  Future<List<Map<String, dynamic>>> ProffessorHistory() async {
    ...
    final response =
        await http.get(Uri.parse('$baseUrl/professor/affective-hisotry'));
...
/*STAFF*/
  Future<List<Map<String, dynamic>>> StaffHistoryWidget() async {
    ...
    final response =
        await http.get(Uri.parse('$baseUrl/staff/reward-approved'));
  ...
  Future<List<Map<String, dynamic>>> getStaffRewardRequestList() async {
    ...
    final response =
        await http.get(Uri.parse('$baseUrl/staff/reward-request-list'));
  ...
  Future<bool> approveReward(
      {required int requestId, required int approvedBy}) async {
  ...
  Future<void> updateReward({
    ...
    if (imageFile != null) {
      var file =
          await http.MultipartFile.fromPath('reward_image', imageFile.path);
      request.files.add(file);
    }
  ...
  Future<String?> fetchPointExpire() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to load point expire date. Status code: ${response.statusCode}');
        return null;
      }
    } catch (e) {
  ...
  Future<bool> updatePointExpire(String newDate) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
            'Failed to update point expire date. Status code: ${response.statusCode}');
        return false;
      }
    } catch (e) {
